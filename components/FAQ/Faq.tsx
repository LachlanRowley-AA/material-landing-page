...
import { Box, Container, Stack, Text, rem, Card, Accordion, Group, ThemeIcon, useMantineTheme } from '@mantine/core';
...
export const FAQ = ({ variant = 'cards' }: { variant?: 'cards' | 'accordion' }) => {
  ...
  return (
    <Box
      ...
      style={{ 
        minHeight: "100vh",
        background: "radial-gradient(ellipse at center, rgba(1, 225, 148, 0.03) 0%, black 70%)"
      }}
    >
      <Container size="lg">
        <motion.div
        ...
        >
          <Stack align="center" gap="lg" mb={{ base: rem(40), md: rem(60) }}>
            ...
            >
              Get quick answers to common questions about our business loans and application process.
            </Text>
          </Stack>
        </motion.div>
        ...
        >
          <Card 
            padding="xl" 
            radius="lg" 
            bg="linear-gradient(135deg, rgba(1, 225, 148, 0.1) 0%, rgba(1, 225, 148, 0.05) 100%)"
            style={{ 
          ...
          >
            <Stack align="center" gap="md">
              ...
              <Text size="md" c="rgba(255, 255, 255, 0.8)" ta="center" maw={500}>
                Our team is here to help you understand how our business loans can work for your specific situation.
              </Text>
            </Stack>
          </Card>
        </motion.div>
