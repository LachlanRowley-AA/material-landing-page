...
export default async function DBM_WaffleDataLoaderServer({
  accountKey,
  children,
  ...
  if (accountKey) {
    try {
      ...
      const response = await fetch(
        `https://script.google.com/macros/s/AKfycbxuE_4OFAVDltg6Lr9msf14rrM1_jw0ExHvPUlgTpGMf3aanAAzN1I2ieDHfy7y0HZB/exec?accountKey=${encodeURIComponent(accountKey)}`,
        { cache: 'no-store' }
      );
